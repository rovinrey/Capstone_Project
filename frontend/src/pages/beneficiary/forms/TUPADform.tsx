...
import Form from "../../../components/form"; // Ensure this component correctly forwards 'name', 'value', and 'onChange'
...
function TupadForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(`${API_BASE}/forms/apply/tupad`, formData);
