    ...
    return (
        <section className="w-full max-w-4xl mx-auto">
            <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6 md:p-8 shadow-sm">
                <h1 className="text-xl sm:text-2xl font-bold mb-2 text-gray-900">Application</h1>
                <p className="text-sm sm:text-base text-gray-600">Welcome to the Application page. Here you can manage your applications.</p>
                {user && (
