...
import { ClipboardList, LayoutGrid, Clock } from "lucide-react"; // Added for better UI icons

function BeneficiaryDashboard() {
    const [view, setView] = useState('apply'); // 'apply' or 'status'
                ...
                <div className="flex gap-4 mb-6 mt-4">
                    <button 
                        ...
                        className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all ${
                            view === 'apply' ? "bg-blue-600 text-white shadow-lg shadow-blue-100" : "bg-white text-gray-500 hover:bg-gray-100"
                        }`}
                    >
                        <LayoutGrid size={18} />
                        New Application
                    ...
                    <button 
                        ...
                        className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all ${
                            view === 'status' ? "bg-blue-600 text-white shadow-lg shadow-blue-100" : "bg-white text-gray-500 hover:bg-gray-100"
                        }`}
                    >
                        <Clock size={18} />
                        Check Status
