                        ...
                        <div key={key}>
                            ...
                            {isEditable ? (
                                <input
                                    ...
                                    className="mt-1 w-full px-3 py-1.5 text-sm border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                                />
                            ) : (
    ...
    return (
        <div className="space-y-6 print:space-y-4">
            ...
            {!loading && !error && details && (
                <>
                    {/* Quick summary bar */}
                    <div className="rounded-2xl border border-gray-200 bg-gradient-to-r from-blue-50 to-white px-6 py-5 shadow-sm print:border print:shadow-none">
