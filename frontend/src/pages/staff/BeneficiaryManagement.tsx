    ...
    const fetchBeneficiaries = async () => {
        ...
        try {
            const endpoint = selectedStatus === "All"
                ...
                : `http://localhost:5000/api/beneficiaries?status=${selectedStatus}`;
                            ...
                            <div key={beneficiary.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                                <div className="flex items-start justify-between">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className="flex-1 bg-gray-200 rounded-full h-2">
                                                        <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${beneficiary.progress}%` }}></div>
                                                    </div>
                                    ...
                                    <div className="flex gap-2">
                                        <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">View Details</button>
