...
const Attendance = () => {
    ...
    const fetchAttendance = async () => {
        ...
        try {
            const [historyRes, todayRes] = await Promise.all([
                axios.get<AttendanceRecord[]>('http://localhost:5000/api/attendance', authHeaders),
                axios.get<TodayAttendanceResponse>('http://localhost:5000/api/attendance/today', authHeaders)
            ]);
    ...
    const timeIn = async () => {
        ...
        try {
            await axios.post('http://localhost:5000/api/attendance/time-in', {}, authHeaders);
    ...
    const timeOut = async () => {
        ...
        try {
            await axios.post('http://localhost:5000/api/attendance/time-out', {}, authHeaders);
            await fetchAttendance();
        } catch (err: any) {
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-lg font-semibold text-sm bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
