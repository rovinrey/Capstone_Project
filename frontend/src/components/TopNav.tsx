        ...
        <nav className="bg-white border-b border-gray-200">
            ...
            {isOpen && (
                <div className="md:hidden bg-gray-50 border-t border-gray-200 px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a href="#" className="block px-3 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-md">Solutions</a>
                    <a href="#" className="block px-3 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-md">Pricing</a>
                </div>
            )}
        </nav>
    );
