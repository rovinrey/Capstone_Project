...
const PROGRAMS: ProgramMeta[] = [
    ...
    { key: 'SPES', apiKey: 'spes', label: 'SPES — Student Employment', shortLabel: 'SPES', color: 'text-blue-600', bgColor: 'bg-blue-50', ringColor: 'ring-blue-200', badgeBg: 'bg-blue-100', badgeText: 'text-blue-700' },
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-lg ${allComplete ? 'bg-emerald-100' : 'bg-blue-100'}`}>
                            <FolderOpen className={`h-4 w-4 ${allComplete ? 'text-emerald-600' : 'text-blue-600'}`} />
                        </div>
                        <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                    <div
                        className={`h-2.5 rounded-full transition-all duration-700 ease-out ${allComplete ? 'bg-emerald-500' : 'bg-blue-600'}`}
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="mt-1 w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                                        <div
                                            className={`h-1.5 rounded-full transition-all duration-500 ${ps.isComplete ? 'bg-emerald-500' : 'bg-blue-500'}`}
                                            style={{ width: `${pct}%` }}
                                        />
                                    </div>
                                </div>
        ...
        <div className="w-full space-y-5">
            ...
            <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-5 shadow-sm">
                ...
                <div className="mt-4 w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                    <div
                        className={`h-3 rounded-full transition-all duration-700 ease-out ${allComplete ? 'bg-emerald-500' : 'bg-blue-600'}`}
                        style={{ width: `${overallPct}%` }}
                    />
                </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="hidden sm:block w-24">
                                        <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                                            <div
                                                className={`h-2 rounded-full transition-all duration-500 ${ps.isComplete ? 'bg-emerald-500' : 'bg-blue-500'}`}
                                                style={{ width: `${pct}%` }}
                                            />
                                        </div>
                                    </div>
