                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3">
                    {req.file ? (
                      ...
                      <label
                        htmlFor={`file-${req.id}`}
                        className="flex cursor-pointer items-center gap-2 rounded-lg border border-dashed border-gray-300 px-3 py-2 text-xs text-gray-500 hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50 transition-colors"
                      >
                        <svg
