                ...
                <div className="flex items-center justify-between mb-2.5">
                    <div className="flex items-center gap-2">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-lg ${allComplete ? 'bg-emerald-100' : 'bg-blue-100'}`}>
                            <svg className={`h-4 w-4 ${allComplete ? 'text-emerald-600' : 'text-blue-600'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex items-center gap-3 rounded-xl border border-emerald-200 bg-white p-3">
                                                        ...
                                                        <a
                                                            ...
                                                            className="inline-flex items-center gap-1.5 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-100 transition-colors ring-1 ring-inset ring-blue-200"
                                                        >
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        {isBusy ? (
                                                            ...
                                                            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-500 group-hover:bg-blue-100 transition-colors">
                                                    ...
                                                    {isBusy && (
                                                        <div className="mt-2">
                                                            ...
                                                            <p className="mt-1 text-xs text-blue-600 font-medium">{slot.progress}% uploaded</p>
                                                        </div>
                                                    )}
                                                </>
                                            )}
