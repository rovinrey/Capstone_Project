...
const REQUIREMENTS: RequirementDef[] = [
    {
        id: 'spes_form2a',
        label: 'SPES Form 2a',
        description: 'Supplemental application form with family background and income details.',
...
function ProgressBar({ pct }: { pct: number }) {
    return (
        <div className="mt-2">
            ...
            <p className="mt-0.5 text-xs text-blue-600 font-medium">{pct}% uploaded…</p>
        </div>
    );
}
        ...
        <div className="w-full">
            ...
            <div className="mb-6 rounded-2xl border border-gray-200 bg-gray-50 p-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                    <div
                        className={`h-3 rounded-full transition-all duration-500 ${allComplete ? 'bg-emerald-500' : 'bg-blue-600'}`}
